            ...
            <div id="sidebar-scrollbar">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li><a href="managecontact"><i class="fa fa-address-book-o" aria-hidden="true"></i>Contact</a></li>
                        <li>
                            </div>
                            </div>
                            <!-- TOP Nav Bar -->
                                                        ...
                                                        <form action="userdetails" method="POST">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone Number" value="${u.phone}" />
                                                                    <span class="text-danger">${msgPhone}</span>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="date" class="form-control" id="birthdate" name="birthdate" value="${u.birthDate}" />
                                                                    <span class="text-danger">${msgBirthdate}</span>
                                                                </div>

                                                                <div class="form-group col-md-6">
                                                                    <label>User Role: </label>
                                                                    <input type="text" disabled="" class="form-control" id="role" name="role" value="${u.role.role_name}" />
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" id="address" name="address" placeholder="Address" value="${u.address}" />
                                                                </div>
                                                            </div>
