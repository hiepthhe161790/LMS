<%-- 
    Document   : manage_lesson
    Created on : 10 Dec 2023, 14:25:35
    Author     : Yen Do
--%>
            ...
            <div id="sidebar-scrollbar">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="active">
                            <a href="lessonManage" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><span class="ripple rippleEffect"></span><i class="fa fa-address-book-o" aria-hidden="true"></i><span>Manage Lesson</span></a>
                        </li>
                                            ...
                                            <div class="iq-card-body">
                                                <div class="table-responsive">
                                                    <div class="row justify-content-between">
                                                        <div class="col-md-12">
                                                            <h4 class="card-title">List Of Lesson</h4>
                                                            <div id="user_list_datatable_info" class="dataTables_filter">
                                                                <form action="lessonManage" method="get">
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <select name="subject" style="width: 100%" class="form-control" id="subject">
                                                                                ...
                                                                                <c:forEach items="${listAllSubject}" var="subject">
                                                                                    <option value="${subject.id}" ${subject.id eq selectedSubjectId ? 'selected' : ''}>${subject.name}</option>
                                                                                </c:forEach>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <select name="status" style="width: 100%" class="form-control" id="status">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <input class="mt-1" type="submit" value="Search"/>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                    ...
                                                    <div class="text-right mt-3">
                                                        <a href="chapterManage" class="mr-4"><i class="fa fa-plus"></i> Create Chapter</a>
                                                        <a href="chapterManage" class="mr-2"><i class="fa fa-plus"></i> Create Lesson</a>
                                                    </div>
                                                    <table id="user-list-table" class="table table-striped table-bordered mt-1" role="grid" aria-describedby="user-list-page-info">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${getAllLesson}" var="c" varStatus="loop">
                                                                <tr class="mt-30">
                                                                    <td>${loop.index + 1}</td>
                                                                    <td>${c.chapterType.chapterName}</td>
                                                                    <td>${c.lessonName}</td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="flex align-items-center list-user-action" style="display: flex">
                                                                            <a class="iq-bg-primary" data-toggle="modal" data-original-title="Details" data-target=".bd-example-modal-lg" onclick="loadChapterData('${c.lessonId}')">
                                                                                <i class="fa fa-edit"></i>
                                                                            </a>
                                                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#" onclick="showConfirmDialog('${c.lessonId}')">
                                                ...
                                                <div class="row justify-content-between mt-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <c:if test="${not empty getAllLesson}">
