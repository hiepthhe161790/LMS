...
<html>
    <head>
        ...
        <link href="style/rspassword.css" rel="stylesheet" type="text/css"/>

    </head>
    <body>
  <%@include file="header.jsp" %>
        <div style="background-image: linear-gradient(#FFFCCE, #FFB330 );color: black;margin-top: 200px;" class="change-password"> 
