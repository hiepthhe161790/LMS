                                                        ...
                                                        <form action="adduser" method="POST">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-sm-12">
                                                                    ...
                                                                    <input type="email" class="form-control" id="email" name="email" onblur="validateEmail()" oninput="resetEmail()" required/>
<!--                                                                    <span class="text-danger">${msgEmail}</span>-->
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" id="phone" name="phone" onblur="validatePhone()" oninput="resetPhone()" />
                                                            ...
                                                            <button type="submit" id="editUserBtn" class="btn btn-primary">Add User</button>
                                                        </form>
