                                            ...
                                            <div class="iq-card-body">
                                                <div class="table-responsive">
                                                    <div class="row justify-content-between">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div id="user_list_datatable_info" class="dataTables_filter">
                                                                <form class="mr-3 position-relative" action="settingsList" method="get">
                                                        ...
                                                        <!-- Add New User Button -->
                                                        <button class="btn btn-primary mr-3" style="font-weight: bold" onclick="window.location.href = 'settingadd'" data-toggle="model" data-original-title="Add Setting" data-target="#addNewSettingModal">
                                                            Add New Setting
                                                        </button>
                                                    </div>
                                                    ...
                                                    <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${getAllSettings}" var="s" varStatus="loop">
                                                                <tr>
                                                                    <th>${loop.index+1}</th>
                                                                    <th>${s.name}</th>
                                                                    <th>${s.mapped_values}</th>
                                                                    <th>
                                                                        ${s.settingType.name}
                                                                    </th>
                                                                    <th>${s.order}</th>
                                                                    <th>
                                                                        <c:if test="${s.status eq true}">Active</c:if>
                                                                        <c:if test="${s.status ne true}">Deactive</c:if>

                                                                        </th>
                                                                        <th>
                                                                            <div class="flex align-items-center list-user-action" style="display: flex">
                                                                                <a class="iq-bg-primary" href="settingdetail?id=${s.id}"
                                                                               <!--data-toggle="modal" data-original-title="Details" data-target=".bd-example-modal-lg" data-contact-id="${s.id}"-->
                                                                                <i class="fa fa-eye"></i>
                                                                            </a>
                                                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#" onclick="showConfirmDialog('${s.id}')">
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Setting Detail</h5>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div>
                                                                                <input class="form-control" style="width: 100%" type="text" name="status"/>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div>
                                                                                <textarea class="form-control" id="exampleFormControlTextarea1" class="description" rows="5"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row justify-content-between mt-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <c:if test="${not empty getAllSettings}">
