                                            ...
                                            <div class="iq-card-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${assignmentList}" var="ass" varStatus="loop">
                                                                <tr class="mt-30">
                                                                    ...
                                                                    <td>${ass.isDeleted}</td>
                                                                    <td>
                                                                        <button onclick="window.location.href = './assignmentListDetail?assignment_id=${ass.assignmentId}'">Detail</button>
                                                                    </td>
                                                                </tr>
                                                            </c:forEach>
                                                        </tbody>
