                ...
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        <li class="active active-menu">
                            <a href="userList" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true"><span class="ripple rippleEffect"></span><i class="las la-user-tie iq-arrow-left"></i><span>Manage User</span></a>
                        </li>
                        <li>
                                                    ...
                                                    <div class="row justify-content-between">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div id="user_list_datatable_info" class="dataTables_filter">
                                                                <form class="mr-3 position-relative" action="userList" method="get">
                                                        ...
                                                        <!-- Add New User Button -->
                                                        <button class="btn btn-primary mr-3" style="font-weight: bold" onclick="window.location.href='adduser'" data-toggle="model" data-original-title="Add New User" data-target="#addNewUserModal">
                                                            Add New User
                                                        </button>
