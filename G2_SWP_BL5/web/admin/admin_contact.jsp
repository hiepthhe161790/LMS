                                            ...
                                            <div class="iq-card-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${getAllContact}" var="c" varStatus="loop">
                                                                <tr class="mt-30">
                                                                    <td>${loop.index + 1}</td>
                                                                    <td>${c.name}</td>
                                                                    <td>${c.email}</td>
                                                                    ...
                                                                    <td>
                                                                        <div class="flex align-items-center list-user-action" style="display: flex">
                                                                            <a class="iq-bg-primary" data-toggle="modal" data-original-title="Details" data-target=".bd-example-modal-lg" data-contact-id="${c.contactID}">
                                                                                <i class="fa fa-eye"></i>
                                                                            </a>
                                                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="#" onclick="showConfirmDialog('${c.contactID}')">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div>
                                                                                <input class="form-control" style="width: 100%" type="text" name="fullname"/>
                                                                            </div>
                                                                            <div>
                                                                                <label>Email:</label>
                                                                            </div>
                                                                            <div>
                                                                                <input class="form-control" style="width: 100%" type="text" name="email" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div>
                                                                                <input class="form-control" style="width: 100%" type="text" name="address"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div>
                                                                                <input class="form-control" style="width: 100%" type="text" name="contactType"/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div>
                                                                                <textarea class="form-control" id="exampleFormControlTextarea1" class="message" rows="5"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
