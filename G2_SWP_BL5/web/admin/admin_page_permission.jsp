                                        ...
                                        <div class="iq-card">
                                            <div class="iq-card-header d-flex justify-content-between">
                                                <div class="iq-header-title">
                                                    <h4 class="card-title">Page Permission List</h4>
                                                </div>
                                            </div>
                                            <div class="iq-card-body">
                                                <div class="table-responsive">
                                                    <div class="row justify-content-between">
                                                        <div class="col-sm-12 col-md-6">
                                                            <div id="user_list_datatable_info" class="dataTables_filter">
                                                                <form class="mr-3 position-relative" action="pagePermission" method="GET">
                                                    ...
                                                    <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${getAllPage}" var="page" varStatus="loop">
                                                                <tr class="mt-30">
                                                                    <td>${page.id}</td>
                                                                    <td>${page.name}</td>
                                                                    <c:forEach items="${pagePermissionDAO.getPagePermissionByPageId(page.id)}" var="pageP">
                                                                        <td>
                                                                            <input type="checkbox" id="checkbox1for${pageP.getId()}" name="checkbox1" value="${pageP.getId()}" ${pageP.isCreatable() ? "checked" : ""} onchange="updatePermission(this.id, 'isCreatable')">
                                                                            <label for="checkbox1">Create</label><br>
                                                                            <input type="checkbox" id="checkbox2for${pageP.getId()}" name="checkbox2" value="${pageP.getId()}" ${pageP.isReadable() ? "checked" : ""} onchange="updatePermission(this.id, 'isReadable')">
                                                                            <label for="checkbox2">Read</label><br>
                                                                            <input type="checkbox" id="checkbox3for${pageP.getId()}" name="checkbox3" value="${pageP.getId()}" ${pageP.isUpdatable() ? "checked" : ""} onchange="updatePermission(this.id, 'isUpdatable')">
                                                                            <label for="checkbox3">Update</label><br>
                                                                            <input type="checkbox" id="checkbox4for${pageP.getId()}" name="checkbox4" value="${pageP.getId()}" ${pageP.isDeletable() ? "checked" : ""} onchange="updatePermission(this.id, 'isDeletable')">
