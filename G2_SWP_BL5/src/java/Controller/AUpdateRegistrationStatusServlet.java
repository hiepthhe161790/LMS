 ...
 * @author VIETHUNG
 */
@WebServlet(name="AUpdateRegistrationStatusServlet", urlPatterns={"/updateRegistrationStatusServlet"})
public class AUpdateRegistrationStatusServlet extends HttpServlet {
