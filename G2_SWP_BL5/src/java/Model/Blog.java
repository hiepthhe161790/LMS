...
public class Blog {
 ...
 private int numberOfAccess;
    ...
    public Blog(int blog_id, String title, String author, String image, String brief_info, Date createDate, String blog_content, int cate_id, boolean status, String thumbnail, String flag, Date dateModified, int numberOfAccess) {
